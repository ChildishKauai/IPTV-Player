...
impl LoginScreen {
    ...
    pub fn show(
        ...
        let top_space = if is_mobile { 60.0 } else { 80.0 };
        ...
        ui.vertical_centered(|ui| {
            ...
            ui.label(egui::RichText::new("IPTV")
                .size(if is_mobile { 42.0 } else { 56.0 })
            ...
            ui.add_space(if is_mobile { 40.0 } else { 50.0 });
                ...
                .show(ui, |ui| {
                    ...
                    ui.vertical(|ui| {
                        ui.label(egui::RichText::new("Sign In")
                            .size(if is_mobile { 24.0 } else { 28.0 })
                            .color(theme.text_primary)
                            .strong());
                        
                        ui.add_space(if is_mobile { 20.0 } else { 28.0 });
                        
                        // Server URL input
                        Self::input_field(ui, theme, server_url, "Server URL", "http://server:port", input_width, false);
                        ui.add_space(if is_mobile { 12.0 } else { 16.0 });
                        
                        // Username input
                        Self::input_field(ui, theme, username, "Username", "Enter username", input_width, false);
                        ui.add_space(if is_mobile { 12.0 } else { 16.0 });
                        
                        // Password input
                        Self::input_field(ui, theme, password, "Password", "Enter password", input_width, true);
                        
                        ui.add_space(if is_mobile { 24.0 } else { 32.0 });
                        ...
                        if connecting {
                            ...
                            let btn_height = if is_mobile { 48.0 } else { 44.0 };
                            ...
                            .min_size(egui::vec2(input_width, btn_height))
                            .rounding(egui::Rounding::same(4.0));
    ...
    /// Renders a Netflix-style input field.
    fn input_field(
        ui: &mut egui::Ui,
        theme: &Theme,
        value: &mut String,
        ...
        egui::Frame::none()
            ...
            .show(ui, |ui| {
                ...
                let mut edit = egui::TextEdit::singleline(value)
                    .hint_text(egui::RichText::new(placeholder).color(theme.text_secondary))
